...
do
    ...
    ./simulator/websim --users $users --simtime 180000 --warmup 20000 --trace_on 0 --num_cores 4 --max_threads 256 --thread_queue_limit 15000 --quantum 300 --think_base 3000 --context_switch_overhead 0.2 --think_mean_exp 200 --retry_limit 0\
